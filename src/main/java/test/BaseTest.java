...
public class BaseTest {
    ...
    static String toString(final double... coords) {
    ...
    static String toUniformString(BigDecimal decimal) {
        int DIGIT_COUNT = 40;
    ...
    static String toComparisonString(BigDecimal target, String compareAgainst) {
     ...
     */
    static char createCircleDigit(char ch) {
        if (ch >= '1' && ch <= '9') {
            return (char) (ch - '1' + '\u2460');
        }
        if (ch == '0') {
